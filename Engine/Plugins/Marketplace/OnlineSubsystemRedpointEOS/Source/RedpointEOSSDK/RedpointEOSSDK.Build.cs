...
#pragma warning disable CS0162
        ...
        if (false)
        {
            ...
            {
                "20662730-v1.15",  // Superseded by 1.15.1 patch release.
                "18059966-v1.14.1" // 1.14.1 has different revision numbers at some point in the past.
            };
            return Constraints;
            /* PRECOMPILED REMOVE BEGIN */
        }
...
public class RedpointEOSPlatform_Android : IRedpointEOSPlatform
{
    ...
    {
#if UE_5_1_OR_LATER
        var IsSplitSDK = Directory.Exists(Path.Combine(SdkBase, "Bin", "Android", "dynamic-stdc++"));
#else
        ...
        {
            // 1.15.1 and earlier.
            ArmEABILib = Path.Combine(SdkBase, "Bin", "Android", "libs", "armeabi-v7a", "libEOSSDK.so");
            Arm64Lib = Path.Combine(SdkBase, "Bin", "Android", "libs", "arm64-v8a", "libEOSSDK.so");
            AARPath = Path.Combine(SdkBase, "Bin", "Android", "aar");
            AARName = "Bin/Android/aar";
        }
...
public class RedpointEOSSDK : ModuleRules
{
    ...
    {
        "20662730-1.15.1",
        "20662730-v1.15",   // Currently necessary for iOS builds in Free Edition. Excluded for desktop in Free Edition.
        /* PRECOMPILED REMOVE BEGIN */
        "20906061-v1.14.2-hf-2",
        /* PRECOMPILED REMOVE END */
        "21924193-v1.15.3", // De-prioritized due to known P2P networking issues, but necessary for Android builds in 5.1.
    };
