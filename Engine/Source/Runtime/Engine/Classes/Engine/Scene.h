...
// AMD_CHANGES_BEGIN - FidelityFX CAS Integration
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Overrides, meta = (PinHiddenByDefault, InlineEditConditionToggle))
	uint32 bOverride_CasSharpening : 1;

	/** Contrast Adapative Sharpening factor. 0~1 */
	UPROPERTY(interp, BlueprintReadWrite, Category = "AMD Fidelity FX|CAS (Contrast Adaptive Sharpening)", meta = (ClampMin = "0.0", ClampMax = "1.0", editcondition = "bOverride_CasSharpening", DisplayName = "Sharpen"))
	float CasSharpening;
	
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Overrides, meta = (PinHiddenByDefault, InlineEditConditionToggle))
	uint32 bOverride_EnableCasSharpening : 1;
	
	/** Contrast Adapative Sharpening enabling.  */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "AMD Fidelity FX|CAS (Contrast Adaptive Sharpening)", meta = (editcondition = "bOverride_EnableCasSharpening", DisplayName = "Enabled"))
	uint32 EnableCasSharpening : 1;
