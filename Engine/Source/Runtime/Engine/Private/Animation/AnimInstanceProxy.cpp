...
void FAnimInstanceProxy::RegisterSlotNodeWithAnimInstance(const FName& SlotNodeName)
{
	...
	if (SlotNameToTrackerIndex.Contains(SlotNodeName))
	{
		...
		// bob - commented these out.  The anim bps work and not having duplicates of these breaks a lot of the blueprint logic implemented for the creatures and their animations.
