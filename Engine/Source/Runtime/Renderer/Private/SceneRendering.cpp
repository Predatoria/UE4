...
static TAutoConsoleVariable<int32> CVarTestPrimaryScreenPercentageMethodOverride(
	...
	0,
	TEXT("Override the primary screen percentage method for all view family.\n")
	TEXT(" 0: view family's screen percentage interface choice; (default)\n")
	TEXT(" 1: old fashion upscaling pass at the very end right before before UI;\n")
	TEXT(" 2: TemporalAA upsample.\n")
	TEXT(" 3: FidelityFX Super Resolution.\n")
	TEXT(" 4: Raw output.\n"));

static TAutoConsoleVariable<int32> CVarTestSecondarycreenPercentageMethodOverride(
	TEXT("r.Test.SecondaryScreenPercentageMethodOverride"),
	0,
	TEXT("Override the secondary screen percentage method for all view family.\n")
	TEXT(" 0: view family's screen percentage interface choice; (default)\n")
	TEXT(" 1: NearestSpatialUpscale;\n")
	TEXT(" 2: LowerPixelDensitySimulation;\n")
	TEXT(" 3: FidelityFX Super Resolution.\n"));
// AMD_CHANGES_END
...
void FSceneRenderer::PrepareViewRectsForRendering()
{
	...
	for (int32 i = 0; i < Views.Num(); i++)
	{
		...
		// For testing purpose, override the screen percentage method.
		{
			...
			// AMD_CHANGES_BEGIN - FidelityFX Super Resolution
			case 3: View.PrimaryScreenPercentageMethod = EPrimaryScreenPercentageMethod::FFX_FSR; break;
			case 4: View.PrimaryScreenPercentageMethod = EPrimaryScreenPercentageMethod::RawOutput; break;
			// AMD_CHANGES_END
			}
		}
		#endif
	...
	// AMD_CHANGES_BEGIN - FidelityFX Super Resolution
	#if !UE_BUILD_SHIPPING
	switch (CVarTestSecondarycreenPercentageMethodOverride.GetValueOnRenderThread())
	{
		case 1: ViewFamily.SecondaryScreenPercentageMethod = ESecondaryScreenPercentageMethod::NearestSpatialUpscale; break;
		case 2: ViewFamily.SecondaryScreenPercentageMethod = ESecondaryScreenPercentageMethod::LowerPixelDensitySimulation; break;
		case 3: ViewFamily.SecondaryScreenPercentageMethod = ESecondaryScreenPercentageMethod::FFX_FSR; break;
	}
	#endif
	// AMD_CHANGES_END
