...
// Both FSR pass and Tonemapper pass need to access these cvars, hence they're declared here
...
static TAutoConsoleVariable<int32> CVarFSRPostFSRChromaticAberration(
	...
	0,
#else
	// Note: We've noticed some image issues such as jagged edges when FSR1.Post.ExperimentalChromaticAberration is 1
